...
<?php if($_SERVER['REQUEST_URI'] == '/symbol-detail') { ?>
...
<script>
const navLinks = document.querySelectorAll('.item-collapse-close')
const menuToggle = document.getElementById('navbarDexContent')
